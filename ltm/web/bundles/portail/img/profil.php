                    ...
                    <ul class="nav top-2">
                        ...
                        <li class="active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a href="page_column_left.html">2 Columns (Left)</a></li>
...
<div class="breadcrumbs margin-bottom-20">
	<div class="container">
	  <h1 class="color-green pull-left">Rodred ( ici son speudo</h1></br>
...
<div class="container">		
	<div class="row-fluid">
        ...
        <!-- Our Mission -->
            ...
            <div><img src="http://ns351661.ovh.net/~bog33/assets/img/LILWAYNE.jpg" width="182" height="277"></div>
                <div class="headline">
                  <h3>Description</h3>
              </div>
              
                <p>La tu mets le descriptif du gas. <a href="www.likethismoove.com">see more</a></p>
		  </div>            
        
            <!-- Posts -->
            <div class="posts margin-bottom-20">
                <div class="headline"><h3>Follower ( ici tu mets ses follower et following</h3></div>
                ...
                <dl class="dl-horizontal">
                    ...
                    <dd>
                        <p><a href="#">Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee.</a></p> 
                    </dd>
                </dl>
            </div><!--/posts-->
    	...
    	<div class="span9">
            ...
            <div class="row-fluid">
                ...
                <div class="row-fluid servive-block servive-block-in">
                    <div class="span4">
                        <h4><img src="http://ns351661.ovh.net/~bog33/assets/img/slide-1.jpg" alt="" width="450"></h4>
                    </div>
                    <div class="span4"> </div>
                </div><!--/welcome-block-->
            </div><!--/row-fluid-->        
            ...
            <!-- About Us -->
            <div class="headline">
              <h3>Wall ( ici c'est le wall)</h3></div>
            <p><img class="pull-left lft-img-margin img-width-200" src="assets/img/carousel/2.jpg" alt="" />Fusce condimentum eleifend enim a feugiat. Pellentesque viverra ipsum dolor sit amet, consectetur adipiscing elit. Ut non libero magna. Sed et quam lacus. Fusce condimentum eleifend enim a feugiat.</p>
            <ul class="unstyled">
            	<li><i class="icon-ok color-green"></i> Consectetur adipiscing elit</li>
            	<li><i class="icon-ok color-green"></i> Ipsum dolor sit amet</li>
            	<li><i class="icon-ok color-green"></i> Personal and effective approach</li>
            	<li><i class="icon-ok color-green"></i> Ut non libero magna sedot</li>
            </ul><br>
