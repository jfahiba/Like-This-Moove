        ...
        youtubeVideoGallery:function(options) {
            var version = '1.3.0',
                ...
                defaults = {
                    ...
                    playButton: '/ltm/web/bundles/portail/img/youtube-video-gallery/play-button-green@40.png',
                    plugin:'self',
                    style:'',
                    title:'default',
                    thumbWidth:250,
            ...
            function load($this, options) {
                ...
                for (var i = 0, l = videos.length; i < l; i++){
                    ...
                    html+= '<li  class="youtube-videogallery-item ' +video.name + '"   data-id="'+ i +'" ><a title="'+video.title+'" data-youtube-id="'+ video.id +'" href="'+ href +'" class="youtube-videogallery-link" style="width:'+options.thumbWidth+'px"><img class="youtube-videogallery-play" src="'+ playButtonSrc +'" title="play" /><img class="youtube-videogallery-img" src="'+ src +'" style="width:'+options.thumbWidth+'px" />'+ titleSpan +'</a></li>';
                }
                $this.empty()
                    .append(html)
